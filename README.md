...
```sh
git clone https://github.com/GutemaG/JavaScript-capstone-project.git
...
Feel free to check the [issues page](https://github.com/GutemaG/JavaScript-capstone-project/issues).
